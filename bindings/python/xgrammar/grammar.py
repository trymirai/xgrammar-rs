...
class Grammar(XGRObject):
    ...
    def from_json_schema(
        ...
        *,
        ...
        separator_item, separator_kv = separators or (None, None)
    ...
    def concat(*grammars: "Grammar") -> "Grammar":
        ...
        """
        serialized_grammars = [grammar.serialize_json() for grammar in grammars]
        return Grammar._create_from_handle(_core.Grammar.concat(serialized_grammars))
    ...
    def union(*grammars: "Grammar") -> "Grammar":
        ...
        """
        serialized_grammars = [grammar.serialize_json() for grammar in grammars]
        return Grammar._create_from_handle(_core.Grammar.union(serialized_grammars))
