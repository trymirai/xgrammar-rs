    ...
    fn visit_lookahead(
        ...
        match ty {
            ...
            GrammarExprType::EmptyStr => {
                panic!("Empty string should not be in lookahead assertion")
            },
            GrammarExprType::TagDispatch => {
                panic!("TagDispatch should not be in lookahead assertion")
            },
            _ => {
