...
pub use encoding::{
    CharHandlingError, Codepoint, byte_to_latin1, char_to_utf8_bytes, escape_byte, escape_codepoint,
    escape_str, handle_utf8_first_byte, hex_char_to_int, latin1_to_bytes, parse_next_escaped,
    parse_next_utf8, parse_next_utf8_or_escaped, parse_utf8,
};
